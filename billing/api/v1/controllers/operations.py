...
def add_wallet_operation(correlation_id: str, amount: float, reason_id: int, wallet_id_recipient: int,
    ...
    """
    Add wallet operation into table.
    :param correlation_id: unique code to prevent repeated operations
    :param amount: amount of money
    :param reason_id: id reason for crediting funds
    :param wallet_id_recipient: recipient
    :param wallet_id_sender: sender
    :return:
    """
...
async def check_possibility_payment(correlation_id: str, connection) -> bool:
    """
    Check if the current transaction has been completed
    :param correlation_id: unique code to prevent repeated operations
    :param connection:
    :return:
    """
